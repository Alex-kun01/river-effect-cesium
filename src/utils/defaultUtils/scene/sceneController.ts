 ...
 * @LastEditors: DESKTOP-4N6BP56
 * @LastEditTime: 2022-06-08 19:05:34
 */
import CampusController from './campusController';
// import SceneBase from './sceneBase';
import {
    MapAddOpts, MapBaseOpts, CombineOpts, MapConfigOpts
} from './type';
class SceneController extends CampusController {
  map:any
  opts:CombineOpts
  // 定义默认参数
  defaultOpts = {
