...
import { d as defined, a as defaultValue } from './when-2eee95b5.js';
import './Check-ed53c783.js';
import { C as CesiumMath } from './Math-d155d327.js';
import { b as Cartesian2, C as Cartesian3, a as Cartographic } from './Cartesian2-2623b6cf.js';
import { C as Cartesian4, B as BoundingSphere, G as GeographicProjection, M as Matrix4, I as Intersect, a as Matrix3 } from './Transforms-77949152.js';
import { C as ComponentDatatype } from './ComponentDatatype-e94d8aff.js';
import { P as PrimitiveType, G as Geometry, a as GeometryAttribute, b as GeometryType } from './GeometryAttribute-a33bd30f.js';
import { A as AttributeCompression } from './AttributeCompression-9873ed5b.js';
import { E as EncodedCartesian3 } from './EncodedCartesian3-c67e9647.js';
import { I as IndexDatatype } from './IndexDatatype-da360266.js';
import { I as IntersectionTests } from './IntersectionTests-aa94492d.js';
...
var scratchCartesian3$1 = new Cartesian3();
...
function transformPoint(matrix, attribute) {
  if (defined(attribute)) {
    ...
    for (var i = 0; i < length; i += 3) {
      Cartesian3.unpack(values, i, scratchCartesian3$1);
      Matrix4.multiplyByPoint(matrix, scratchCartesian3$1, scratchCartesian3$1);
      Cartesian3.pack(scratchCartesian3$1, values, i);
    }
  }
}
...
function transformVector(matrix, attribute) {
  if (defined(attribute)) {
    ...
    for (var i = 0; i < length; i += 3) {
      Cartesian3.unpack(values, i, scratchCartesian3$1);
      Matrix3.multiplyByVector(matrix, scratchCartesian3$1, scratchCartesian3$1);
      scratchCartesian3$1 = Cartesian3.normalize(
        scratchCartesian3$1,
        scratchCartesian3$1
      );
      Cartesian3.pack(scratchCartesian3$1, values, i);
...
var scratchCartesian2$1 = new Cartesian2();
...
GeometryPipeline.compressVertices = function (geometry) {
  ...
  for (i = 0; i < numVertices; ++i) {
    if (hasSt) {
      Cartesian2.fromArray(st, i * 2.0, scratchCartesian2$1);
      compressedAttributes[
        normalIndex++
      ] = AttributeCompression.compressTextureCoordinates(scratchCartesian2$1);
    }
