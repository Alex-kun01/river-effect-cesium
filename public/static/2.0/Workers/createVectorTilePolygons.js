...
define(['./when-54c2dc71', './Check-6c0211bc', './Math-fc8cecf5', './Cartesian2-686fcfe4', './Transforms-cc3be161', './RuntimeError-2109023a', './WebGLConstants-76bb35d1', './AttributeCompression-6dd8f7a3', './IndexDatatype-53503fee', './IntersectionTests-6f6cffb5', './Plane-641bf1f6', './createTaskProcessorWorker', './EllipsoidTangentPlane-f77698c1', './OrientedBoundingBox-8718c89f', './Color-c494abd3'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, AttributeCompression, IndexDatatype, IntersectionTests, Plane, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, Color) { 'use strict';
