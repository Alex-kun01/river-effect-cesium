...
define(['./when-54c2dc71', './Check-6c0211bc', './Math-fc8cecf5', './Cartesian2-686fcfe4', './WebGLConstants-76bb35d1', './AttributeCompression-6dd8f7a3', './IndexDatatype-53503fee', './createTaskProcessorWorker'], function (when, Check, _Math, Cartesian2, WebGLConstants, AttributeCompression, IndexDatatype, createTaskProcessorWorker) { 'use strict';
