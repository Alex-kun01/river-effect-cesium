...
import { C as Cartesian3, a as Cartographic } from './Cartesian2-2623b6cf.js';
import { b as Interval, a as Matrix3 } from './Transforms-77949152.js';
...
function quadraticVectorExpression(A, b, c, x, w) {
  ...
  var r0 =
    w *
    (x *
      addWithCancellationCheck$1(A[Matrix3.COLUMN2ROW0], A[Matrix3.COLUMN0ROW2]) +
      b.z);
  ...
  for (var i = 0; i < length; ++i) {
    ...
    var right = addWithCancellationCheck$1(r1 * cosine, r0, CesiumMath.EPSILON15);
...
export { IntersectionTests as I, Ray as R };
