...
define(['./when-54c2dc71', './Check-6c0211bc', './Math-fc8cecf5', './Cartesian2-686fcfe4', './Transforms-cc3be161', './RuntimeError-2109023a', './WebGLConstants-76bb35d1', './ComponentDatatype-6d99a1ee', './GeometryAttribute-a6c8267f', './GeometryAttributes-4fcfcf40', './AttributeCompression-6dd8f7a3', './GeometryPipeline-765fdf18', './EncodedCartesian3-87a4ae25', './IndexDatatype-53503fee', './IntersectionTests-6f6cffb5', './Plane-641bf1f6', './GeometryOffsetAttribute-7350d9af', './VertexFormat-7572c785', './GeometryInstance-fa5f9fd6', './arrayRemoveDuplicates-ebc732b0', './BoundingRectangle-6f26f729', './EllipsoidTangentPlane-f77698c1', './ArcType-dc1c5aee', './EllipsoidRhumbLine-6fe24bec', './PolygonPipeline-69a0b388', './PolygonGeometryLibrary-6ec45ac2', './EllipsoidGeodesic-90362846'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, GeometryAttributes, AttributeCompression, GeometryPipeline, EncodedCartesian3, IndexDatatype, IntersectionTests, Plane, GeometryOffsetAttribute, VertexFormat, GeometryInstance, arrayRemoveDuplicates, BoundingRectangle, EllipsoidTangentPlane, ArcType, EllipsoidRhumbLine, PolygonPipeline, PolygonGeometryLibrary, EllipsoidGeodesic) { 'use strict';
    ...
    if (
      ...
      for (var i = 0; i < length; i += 3) {
        ...
        if (vertexFormat.st) {
          ...
          // beigin changed by zhangtengfei
          // 计算侧面贴图坐标 多边形侧面目前仅支持拉伸
          if (wall) {
  ...
  PolygonGeometry.createGeometry = function (polygonGeometry) {
    ...
    // });
    // beigin changed by zhangtengfei
    var result = new GeometryAttribute.Geometry({
      attributes: attributes,
      indices: geometry.indices,
      primitiveType: geometry.primitiveType,
      boundingSphere: boundingSphere,
