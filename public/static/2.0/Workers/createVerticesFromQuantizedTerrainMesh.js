...
define(['./when-54c2dc71', './Check-6c0211bc', './Math-fc8cecf5', './Cartesian2-686fcfe4', './Transforms-cc3be161', './RuntimeError-2109023a', './WebGLConstants-76bb35d1', './ComponentDatatype-6d99a1ee', './AttributeCompression-6dd8f7a3', './IndexDatatype-53503fee', './IntersectionTests-6f6cffb5', './Plane-641bf1f6', './WebMercatorProjection-0b58e736', './createTaskProcessorWorker', './EllipsoidTangentPlane-f77698c1', './OrientedBoundingBox-8718c89f', './TerrainEncoding-971ab603'], function (when, Check, _Math, Cartesian2, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, AttributeCompression, IndexDatatype, IntersectionTests, Plane, WebMercatorProjection, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, TerrainEncoding) { 'use strict';
